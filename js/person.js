...
//         raridade.innerHTML =`raidade:${item.rarity}`
//         peso.innerHTML =`arma:${item.weapon}`}
//     // function listarCaracteristias(characters){
//   document.getElementById("persona").innerHTML = `${}`
   

       

//         const divPersonagemDados = document.createElement('div')
//         divPersonagemDados.innerHTML= `
